...
//
// Nav links use Next.js Link so they work from any page — clicking
// "Owner Dashboard" from /areas/palo-alto navigates back to the
// homepage and scrolls to #dashboard, instead of doing nothing.
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-200/70 bg-white/80 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        {/* Logo / brand mark — always returns to homepage */}
